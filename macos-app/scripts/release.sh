...
SPARKLE_BIN=$(find ~/Library/Developer/Xcode/DerivedData/where-to-vibe*/SourcePackages/artifacts/sparkle/Sparkle/bin -maxdepth 0 2>/dev/null | head -1)
